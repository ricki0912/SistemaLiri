...
public class CHistorialPagos extends CPadre implements Initializable {
	
	@FXML private Button buttonCerrar;
    @FXML private TextField textFieldBuscarHistorialPagos;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		textFieldBuscarHistorialPagos.setOnKeyReleased(new EventHandler<Event>() {
	...
	public void cargarTablaRecomendado(int IdRecom){
		...
		tableViewClienteRecom.setItems(mRecomendacion.seleccionarColeccionRecomendacion(IdRecom, 1));
	...
	public void traerSumaTotalRecomendado(){
		mRecomendacion.iniciarConexionServidor();
		labelMontoTotal.setText(mRecomendacion.montoPagarRecomendado(id, 1));		
		mRecomendacion.cerrarConexionServidor();
	}
